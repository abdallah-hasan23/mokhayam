...
<title>@yield('title', config('app.name', 'مخيّم')) — صدى النزوح</title>
...
@php
  ...
  $footerAbout    = \App\Models\Setting::get('footer_about')    ?: 'منصة صحفية عربية مستقلة تروي قصص الإنسان في زمن الحرب والنزوح. الكتابة مقاومة.';
  $heroSubtitle   = \App\Models\Setting::get('about_hero_subtitle') ?: '';
@endphp
    ...
    <div class="header-inner">
        <div class="nav-inner">
            ...
            <div class="nav-logo-wrap">
                ...
                @else
                  <a href="{{ route('home') }}" class="nav-logo-text">{{ $siteName }}</a>
                @endif
            </div>
            ...
            <div class="nav-actions">
                <a href="{{ route('contact') }}" class="nav-cta btn-gold">تواصل معنا</a>
